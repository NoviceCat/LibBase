 ...
 *
 */
abstract class BaseListActivity<T, A : BaseQuickAdapter<T, *>, VM : BaseViewModel> :
    BaseActivity<IncludeDefaultRecyclerviewListBinding, VM>() {
    ...
    open fun getLayoutManager(): RecyclerView.LayoutManager {
        return LinearLayoutManagerWrap(this)
    }
    ...
    open fun setBackgroundColor(@ColorRes color: Int) {
        setBackgroundColorInt(ContextCompat.getColor(this, color))
    }
