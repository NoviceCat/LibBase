...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = Core.Companion.getContext().getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (Core.Companion.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, Core.Companion.getContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = Core.Companion.getContext().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = Core.Companion.getContext().getResources();
    ...
    private static String getResNameById(int id) {
        try {
            return Core.Companion.getContext().getResources().getResourceEntryName(id);
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) Core.Companion.getContext().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(Core.Companion.getContext()).hasPermanentMenuKey();
