...
public class LoadingView extends View {
    ...
    private void setup(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LoadingView, defStyleAttr, defStyleRes);
        ...
        mStrokeWidth = typedArray.getDimension(R.styleable.LoadingView_aiv_strokeWidth, mStrokeWidth);
